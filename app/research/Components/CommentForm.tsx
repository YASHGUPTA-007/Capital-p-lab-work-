...
export default function CommentForm({ researchId, onCommentSubmitted }: CommentFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <textarea
              ...
              rows={5}
              placeholder="Share your thoughts, insights, or questions about this research..."
              disabled={loading}
              required
            />
          </div>
    ...
    <div className="bg-white border-2 border-[#c1b4df]/30 rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-between pt-2">
          <p className="text-xs text-[#4f475d]/60 max-w-md">
