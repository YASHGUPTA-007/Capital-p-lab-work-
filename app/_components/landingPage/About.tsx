        ...
        >
          ...
          <div className="max-w-5xl mx-auto relative z-20">
            ...
            <div className="space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8 font-sans text-[#2b2e34] text-sm sm:text-base md:text-lg leading-relaxed max-w-4xl mx-auto">
              ...
              <p className="first-letter:text-4xl first-letter:sm:text-5xl first-letter:md:text-6xl first-letter:lg:text-7xl first-letter:float-left first-letter:mr-2 first-letter:sm:mr-3 first-letter:md:mr-4 first-letter:leading-none first-letter:text-[#755eb1] first-letter:font-serif first-letter:font-bold">
              ...
              {/* Pull Quote - Simplified on mobile */}
