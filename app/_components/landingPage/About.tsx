...
export const AboutSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-[350px] sm:w-[450px] md:w-[500px] h-[350px] sm:h-[450px] md:h-[500px] bg-[#c1b4df]/15 rounded-full blur-[100px] sm:blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[350px] sm:w-[450px] md:w-[500px] h-[350px] sm:h-[450px] md:h-[500px] bg-[#c7d6c1]/15 rounded-full blur-[100px] sm:blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-20 mb-12 sm:mb-16 md:mb-20 lg:mb-28 items-center">
          ...
          >
            ...
            <div className="absolute inset-0 rounded-xl sm:rounded-2xl md:rounded-[2.5rem] border-2 border-[#c1b4df] translate-x-2 translate-y-2 sm:translate-x-3 sm:translate-y-3 md:translate-x-4 md:translate-y-4 -z-10" />
          </motion.div>
          ...
          <motion.div 
            ...
            whileInView="visible"
            viewport={{ once: true, margin: isMobile ? "-20px" : "-100px" }}
            transition={{ duration: isMobile ? 0.4 : 0.6, delay: isMobile ? 0 : 0.2 }}
            variants={slideVariants}
            className="space-y-5 sm:space-y-6 md:space-y-8"
          >
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-[29px] font-light font-sans text-[#2b2e34] leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 md:gap-4 pt-4 sm:pt-6 md:pt-8">
              {[
                ...
                <div 
                  key={i}
                  className="p-3.5 sm:p-4 md:p-5 rounded-lg sm:rounded-xl md:rounded-2xl border md:hover:border-current md:transition-colors md:duration-300 bg-[#d4cbea]/70"
        ...
        <motion.div 
          ...
          transition={{ duration: isMobile ? 0.4 : 0.6 }}
          variants={slideVariants}
          className="relative p-5 sm:p-8 md:p-12 lg:p-16 rounded-xl sm:rounded-2xl md:rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden"
        >
          {/* Background Elements */}
          <div className="absolute inset-0 bg-white/60 backdrop-blur-xl z-0" />
          <div className="absolute -top-16 sm:-top-20 -right-16 sm:-right-20 w-[300px] sm:w-[450px] md:w-[600px] h-[300px] sm:h-[450px] md:h-[600px] bg-[#c1b4df]/30 rounded-full blur-[100px] sm:blur-[120px] mix-blend-multiply z-0" />
          <div className="absolute -bottom-16 sm:-bottom-20 -left-16 sm:-left-20 w-[250px] sm:w-[350px] md:w-[500px] h-[250px] sm:h-[350px] md:h-[500px] bg-[#c7d6c1]/20 rounded-full blur-[80px] sm:blur-[100px] mix-blend-multiply z-0" />
          <div className="hidden sm:block absolute inset-0 opacity-[0.03] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] z-0 mix-blend-overlay" />
          <div className="absolute inset-0 rounded-xl sm:rounded-2xl md:rounded-[2.5rem] lg:rounded-[3rem] border border-[#755eb1]/10 z-10" />
          ...
          <div className="max-w-5xl mx-auto relative z-20">
            ...
            {/* Story Content */}
            <div className="space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8 font-sans text-[#2b2e34] text-sm sm:text-base md:text-lg leading-relaxed max-w-4xl mx-auto">
                  
              <p className="first-letter:text-4xl first-letter:sm:text-5xl first-letter:md:text-6xl first-letter:lg:text-7xl first-letter:float-left first-letter:mr-2 first-letter:sm:mr-3 first-letter:md:mr-4 first-letter:leading-none first-letter:text-[#755eb1] first-letter:font-serif first-letter:font-bold first-letter:drop-shadow-sm">
              ...
              {/* Pull Quote */}
              <div className="mt-6 sm:mt-8 md:mt-10 p-4 sm:p-5 md:p-6 lg:p-8 rounded-lg sm:rounded-xl md:rounded-2xl bg-gradient-to-r from-[#755eb1]/5 to-[#4f7f5d]/5 border-2 border-[#4f7f5d] relative">
                <div className="absolute -top-2.5 sm:-top-3 md:-top-4 -left-1 sm:-left-1.5 md:-left-2 bg-white px-1.5 sm:px-2 text-[#4f7f5d]">
                   <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="sm:w-[24px] sm:h-[24px] md:w-[28px] md:h-[28px] lg:w-[30px] lg:h-[30px]">
